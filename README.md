im: To perform COVID-19 data analysis using Pandas and visualize insights from real-world dataset.

Theory: Pandas: A Python library used for data manipulation and analysis using DataFrames.
